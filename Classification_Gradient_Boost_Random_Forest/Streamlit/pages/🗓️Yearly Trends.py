...
def main():
    ...
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='GAWestNileProject&#47;Yearlytrenddashboard' />
    ...
    st.markdown(f'Link to the public dashboard [here](https://public.tableau.com/app/profile/altheaxcvii/viz/GAWestNileProject/Yearlytrenddashboard)')
