...
def main():
    ...
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='GAWestNileProject&#47;weatherdashboard' />
    ...
    """
    components.html(html_temp, width=1100, height=1200)
    st.markdown(f'Link to the public dashboard [here](https://public.tableau.com/app/profile/altheaxcvii/viz/GAWestNileProject/weatherdashboard)')
