...
#Configurations
st.set_page_config(page_title='West Nile Virus - Map Trends', page_icon='🦟', layout='wide')
...
def main():
    ...
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='GAWestNileProject&#47;MapDashboard' />
    ...
    """
    components.html(html_temp, width=1100, height=1600)
    st.markdown(f'Link to the public dashboard [here](https://public.tableau.com/app/profile/altheaxcvii/viz/GAWestNileProject/MapDashboard)')
